...
(function(){	
	...
	function attachModalHandlers(modal, shouldBlockSite){
		function success(){
			...
			reloadBtn.classList.add("prokeys-block-dialog-button-primary", "prokeys-block-dialog-button");
		...
		var msgElm = modal.querySelector(".prokeys-block-dialog-message"),
			siteNameInput = modal.querySelector(".site-name"), 
			btnContainer = modal.querySelector(".prokeys-block-dialog-buttons"),
			buttons = modal.querySelectorAll(".prokeys-block-dialog-button"),
			OKBtn =  buttons[0],
			cancelBtn =  buttons[1],
			siteInputElm = modal.querySelector(".prokeys-block-dialog-form input"),
